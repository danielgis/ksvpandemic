...
_TRACK_NA = r'D:\proyectos\senamhi\data_vias\mca_1_2.gdb\NAEHidro\NAEHidro_ND'
_TRACK_SHP = r'D:\proyectos\senamhi\data_vias\mca_1_2.gdb\NAEHidro\GPL_Tracks'
_INCIDENTS = r'D:\proyectos\senamhi\data_vias\EH_GPT_Base.shp'
_FACILITIES = r'D:\proyectos\senamhi\data_vias\mca_1_2.gdb\GPT_CcppUrbano'
_TARGET_SHP = r'D:\proyectos\senamhi\data_vias\mca_1_2.gdb\GPL_TrackByEHidrometrica_2021'
_OUT_CSV = r'D:\proyectos\senamhi\criterioaccesibilidad.csv'
_CODCCPP = 'CODCCPP'
_HYBASID = 'HYBAS_ID' # id de cada estacion hidrometrica
_SUPVIA = 'SUP_VIA'
_HIERARCHY = 'HIERARCHY'
_TOLERANCE = '5000 Meters'
_BUFER_DISTANCE = '1 Meters'
...
def execute_analyst(hybasid):
    ...
    try:
        ...
        buff = arcpy.Buffer_analysis('Closest Facility\Routes', 'in_memory\\a{}'.format(name), _BUFER_DISTANCE)
        clip = arcpy.Clip_analysis(_TRACK_SHP, buff, 'in_memory\\b{}'.format(name))

        # print([i.name for i in arcpy.ListFields(clip)])
